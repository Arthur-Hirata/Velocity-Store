...
const arrayEditIputs = [inputItemId, inputNomeItem, inputPrecoItem]
...
function adicionarItem(){
    ...
    const imgItemNovo= inputImgItemNovo.value
    let itemOption = ""
    hardwareOptions.style.border =""
    perifericOptions.style.border =""
    const nullType = document.getElementById("container-null-type")
    nullType.style.visibility="hidden"
    let canAddItem = true
    ...
    if (selectedItemType ==="Hardware"){
        itemOption = document.getElementById("hardware").value
        if (!itemOption || itemOption === "none"){
            nullType.style.visibility="visible"
            hardwareOptions.style.border="1px solid #E11D48"
            return
        }
    }
    if (selectedItemType ==="periferico"){
        itemOption=document.getElementById("perifericos").value
        if (!itemOption || itemOption=== "none"){
            nullType.style.visibility="visible"
            perifericOptions.style.border="1px solid #E11D48"
            return
        }
    }
...
itemTypeButtons.forEach(button => {
    button.addEventListener('click', function() {
        ...
        else if (selectedItemType === "periferico"){
